...
A Governance Object (or "govObject") is a generic structure introduced in Galactrum to allow for the creation of Budget Proposals, Triggers, and Watch Dogs. Class inheritance has been utilized to extend this generic object into a "Proposal" which is outlined throughout the remainder of this document. 
...
####  `checkedSerialize`
Return a hex string that can be used in galactrumd CLI
####  `serialize`
Return a hex string
####  `inspect`
...
```javascript
proposal.url = "https://galactrum.org/badUrl"
var shallowCopyProposal = proposal.shallowCopy();
proposal.url = "https://galactrum.org/fixedUrl"
