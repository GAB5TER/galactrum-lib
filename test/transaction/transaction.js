...
var Payload = orecore.Transaction.Payload;
...
describe('Transaction', function() {
  ...
  it('fromObject with pay-to-public-key previous outputs', function() {
    ...
    tx.inputs[0].should.be.instanceof(orecore.Transaction.Input.PublicKey);
  ...
  describe('checks on adding inputs', function() {
    ...
    it('will add an empty script if not supplied', function() {
      ...
      transaction.inputs[0].output.script.should.be.instanceof(orecore.Script);
  ...
  describe('fromObject', function () {
    it('Should copy transaction when passing instance of Transaction as arg', function() {
      ...
      var copiedTransaction = orecore.Transaction().fromObject(tx);
      expect(copiedTransaction).to.be.an.instanceof(orecore.Transaction);
    });
  });
  ...
  describe('Special transaction payload integration', function () {
    ...
    describe('State transition', function () {
      ...
      var creditFee = 1000; // 0.00001 ore
