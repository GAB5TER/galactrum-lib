...
describe('GovObject', function(){
  ...
  describe('GovObject - FromObject', function(){
    ...
    it('should validate address', function(){
      var govObject = new GovObject;
      govObject._verifyAddress('yjL98aaV2PVXudCfyij17Hofqmh3ynpeFp','testnet').should.equal(true);
      govObject._verifyAddress('Gd2dyjvwkfeVjK4u8hPt5gHuSAvRVDCtBX','livenet').should.equal(true);
      govObject._verifyAddress('Gd2dyjvwkfeVjK4u8hPt5gHuSAvRVDCtBXak78KG78','livenet').should.equal(false);
      govObject._verifyAddress('knPDiVKe91sJasfajkshfjD1nQnnn5B6','testnet').should.equal(false);
      govObject._verifyAddress('Gd2dyjvwkfe&&VjK4u8hPt5gHu/SAvRVDCtBX','livenet').should.equal(false);
      govObject._verifyAddress('Gd2dyjvwkfeVjK4u8hPt5gHuSAvRVDCtB','livenet').should.equal(false);
      govObject._verifyAddress(' Gd2dyjvwkfeVjK4u8hPt5gHuSAvRVDCtB','livenet').should.equal(false);
      govObject._verifyAddress('Gd2dyjvwkfeVjK4u8hPt5gHuSAvRVDCtB ','livenet').should.equal(false);
      govObject._verifyAddress('$Gd2dyjvwkfeVjK4u8hPt5gHuSAvRVDCtB','livenet').should.equal(false);
      govObject._verifyAddress('yjL98aaV2PVXudCfyij17Hofqmh3ynpeFp','livenet').should.equal(false);
      govObject._verifyAddress('Gd2dyjvwkfeVjK4u8hPt5gHuSAvRVDCtBX','testnet').should.equal(false);
    })
...
var expectedHex = "";
